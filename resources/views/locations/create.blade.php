...
@section('content')
              ...
              @endif
                  ...
                  <div class="alert alert-light alert-elevate" role="alert">
                      ...
                      <div class="alert-text">
                          Las ubicaciones que se crea en esta prevista con vistas a proximas actualizaciones de las Apps. <a class="kt-link kt-font-bold" href="https://codeals.es/" target="_blank">here</a>.
                      </div>
                  </div>
							...
							<div class="row">
								...
								<div class="col-lg-12">
									<!-- <div class="kt-portlet"> -->
										...
										<!--begin::Form-->
										<form class="kt-form kt-form--label-right"  action="{{route('admin.locations.store')}}" method="post" enctype="multipart/form-data">
                      @csrf
                      ...
                      <input type="hidden" id="longitude" name="longitude" value="">
                              ...
                              <div class="col-lg-3">
															...
															<div class="col-lg-3">
																...
																<input type="text" name="web" class="form-control" placeholder="" value="{{ old('web') }}">
															</div>

                              <div class="custom-file col-lg-3">
																<label class="form-control-label">Logo </label>
																<input type="file" class="form-control" name="logo" placeholder="" value="{{ old('logo') }}">
															</div>
													...
													<div class="kt-section__content">
														<div class="form-group form-group-last row">
															<div class="col-lg-3">
																...
																<input type="text" name="zip" class="form-control" placeholder="" value="{{ old('zip') }}">
															</div>
                              ...
                              <div class="col-lg-3">
															...
															<div class="col-lg-3">
																...
																<input type="text" class="form-control" name="country" placeholder="" value="{{ old('contry') }}">
															</div>
														...
														<div class="form-group form-group-last row">
															<div class="col-lg-3">
																...
																<input type="text" name="neighborhood" class="form-control" placeholder="" value="{{ old('neighborhood') }}">
															</div>

                              <div class="col-lg-3">
																<label class="form-control-label">Municipio</label>
																<input type="text" name="municipality" class="form-control" placeholder="" value="{{ old('municipality') }}">
															</div>

                              <div class="col-lg-3">
																<label class="form-control-label">Horario de apertura</label>
																<input type="time" class="form-control" name="start_time" placeholder="" value="{{ old('start_time') }}">
															</div>

															<div class="col-lg-3">
																<label class="form-control-label">Horario de cierre</label>
																<input type="time" class="form-control" name="end_time" placeholder="" value="{{ old('end_time') }}">
															</div>
