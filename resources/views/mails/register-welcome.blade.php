...
<div class="content">
    ...
    <div class="row">
      <table width="60%" border="0" align="center">
        <tr>
          <td>
            <h1>Gracias!!! por registrarte en tEncontré :) !!! </h1>
        ...
        <tr>
          <td>
              <table>
                <tr>
                  <td align="center">Te Encontre, a los productos en diferentes tiendas!!!</td>
                  <td align="center">Ayudanos a ayudarte, encuentra y reporta esos prodcutos que tanto necesitamos.</td>
