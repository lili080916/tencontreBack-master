...
<!-- begin:: Subheader -->
              ...
              <div class="kt-container  kt-grid__item kt-grid__item--fluid">
                  <div class="alert alert-light alert-elevate" role="alert">
                      ...
                      <div class="alert-text">
                          El producto que se crea en esta vista es un producto de tipo Admin con todos los accesos y permisos. <a class="kt-link kt-font-bold" href="https://codeals.es/" target="_blank">here</a>.
                      </div>
                  </div>
									...
									<div class="kt-portlet">
										...
										<div class="row">
											...
											<div class="col-lg-6">
												...
												<!--begin::Form-->
												<form class="kt-form kt-form--label-right" action="{{route('admin.products.store')}}" method="post">
                      		                        @csrf
													...
													<div class="kt-portlet__body">
														...
														<div class="form-group row">
															...
															<div class="col-10">
																<input class="form-control" name="product" type="text" value="{{ old('product') }}" id="example-text-input">
															</div>
														</div>
														<div class="form-group row">
